...
import default_profile from '../../assets/image/dummy-avatar.jpg'
                        ...
                        <div key={index}>
                            <div className={`d-flex py-1 ${item.idSender === user.id ? "justify-content-end": "justify-content-start"}`}>
                                {item.idSender !== user.id && (
                                    <img src={contact.profile?.photoUser || default_profile} className="rounded-circle me-2 img-chat" alt="buble-avatar" />
                                )}
                                <div
